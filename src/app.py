...
activities = {
    ...
    "Art Club": {
        ...
        "max_participants": 15,
        "participants": ["lily@mergington.edu", "maria@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting, stagecraft, and school theater productions",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["josh@mergington.edu", "ava@mergington.edu"]
    },
    "Science Olympiad": {
    ...
    "Debate Team": {
        "description": "Develop public speaking, research, and argumentative skills",
